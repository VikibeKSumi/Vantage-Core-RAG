...
def budget_speech_download():
    try:
        ...
        for y2, y1 in enumerate(range(2019, 2026), start=20):
            ...
            url = f"https://www.indiabudget.gov.in/budget{y1}-{y2}/doc/Budget_at_Glance/budget_at_a_glance.pdf"
            ...
            if response.status_code == 200:
                ...
                with open(download_path/f"budget_at_a_glanceFY{y2}.pdf", "wb") as f:
